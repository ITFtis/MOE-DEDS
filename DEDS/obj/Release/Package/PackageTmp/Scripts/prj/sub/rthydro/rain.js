...
(function ($) {
    ...
    pluginclass.prototype = {
        ...
        initUi: function () {
            ...
            var $countySelect = $('<div class="col-6">').appendTo($filterContainer).countySelect({ containerTW: true, autoFitBounds:false, showLabel: false}).on($.countySelect.eventKeys.change, function () {
                setFilter();
            });
